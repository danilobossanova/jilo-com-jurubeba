...
public class CardapioGatewayJpaAdapter implements CardapioGateway {
  ...
  public Cardapio saveCardapio(Cardapio cardapio) {
    ...
    RestauranteJpaEntity restauranteJpa =
        restauranteRepo
            ...
            .orElseThrow(
                () -> new IllegalArgumentException("Restaurante não encontrado para o cardápio"));
  ...
  private Cardapio mapToDomain(CardapioJpaEntity entity) {
    return CardapioJpaMapper.toDomain(entity, restauranteMapper.toDomain(entity.getRestaurante()));
  }
}
