...
public class RestauranteJpaEntity {
    ...
    public TypeCozinha getTypeCozinha() { return typeCozinha; }
    public void setTypeCozinha(TypeCozinha typeCozinha) { this.typeCozinha = typeCozinha; }
    ...
    public UsuarioJpaEntity getDono() { return dono; }
    public void setDono(UsuarioJpaEntity dono) { this.dono = dono; }
