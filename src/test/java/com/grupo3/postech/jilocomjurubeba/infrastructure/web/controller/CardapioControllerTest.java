...
class CardapioControllerTest {
    ...
    void deveListarTodos() {
        ...
        List<CardapioOutput> lista = List.of(
    ...
    void deveBuscarSemRestaurante() {
        ...
        CardapioOutput out = new CardapioOutput(
            1L, "Pizza", "desc", BigDecimal.TEN, false, null, 10L, true
        );
    ...
    void deveCriarComRestauranteDoPath() {
        ...
        CriarCardapioRequest req = new CriarCardapioRequest(
            "Pizza", "desc", BigDecimal.TEN, false, "/foto.png", null
        );

        CardapioOutput out = new CardapioOutput(
            1L, "Pizza", "desc", BigDecimal.TEN, false, "/foto.png", 10L, true
        );
    ...
    void deveCriarComRestauranteDoBody() {
        ...
        CriarCardapioRequest req = new CriarCardapioRequest(
            "Pizza", "desc", BigDecimal.TEN, false, "/foto.png", 20L
        );

        CardapioOutput out = new CardapioOutput(
            1L, "Pizza", "desc", BigDecimal.TEN, false, "/foto.png", 20L, true
        );
    ...
    void deveAtualizarComRestauranteDoPath() {
        ...
        AtualizarCardapioRequest req = new AtualizarCardapioRequest(
            "Pizza", "desc", BigDecimal.TEN, false, "/foto.png", null
        );
    ...
    void deveAtualizarComRestauranteDoBody() {
        ...
        AtualizarCardapioRequest req = new AtualizarCardapioRequest(
            "Pizza", "desc", BigDecimal.TEN, false, "/foto.png", 30L
        );

        CardapioOutput out = new CardapioOutput(
            1L, "Pizza", "desc", BigDecimal.TEN, false, "/foto.png", 30L, true
        );
