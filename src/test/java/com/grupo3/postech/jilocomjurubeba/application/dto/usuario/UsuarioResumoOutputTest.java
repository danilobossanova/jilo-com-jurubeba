...
class UsuarioResumoOutputTest {
  ...
  void deveCriarViaConstrutor() {
    ...
    UsuarioResumoOutput output = new UsuarioResumoOutput(1L, "Juliana", "juliana@email.com");
  ...
  void deveDesserializarJson() throws Exception {
    ...
    UsuarioResumoOutput output = objectMapper.readValue(json, UsuarioResumoOutput.class);
  ...
  void deveSerializarParaJson() throws Exception {
    ...
    UsuarioResumoOutput output = new UsuarioResumoOutput(3L, "Marina", "marina@email.com");
